...
// === i18n (без изменений) ===
// ... (весь твой I18N объект, я его скрыл для краткости, он не менялся) ...
const I18N = {
  ru: {
...
// ... (твой код openModal, closeModal и т.д.) ...
...
// === Firestore LazyLoad (без изменений) ===
// ... (твой код DOMContentLoaded, loadBatch, apply, Search, Tab Bar, Scroll, etc.) ...
